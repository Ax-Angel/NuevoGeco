...
module.exports = function (options, metaOutput, isInitial, srcFiles, callback) {
    ...
    async.waterfall([
        ...
        function (results, callback) {
            ...
            async.waterfall([
                async.parallel.bind(async, [
                    writeCSS.bind(null, options.target.css, spritesheetTemplatesData, isInitial),
                    async.series.bind(async, [
                        writeFileR.bind(null, normalImageName, results[0].image, 'binary'),
                        sendToPast.bind(null, normalImageName, !isInitial)
                    ]),
                    async.series.bind(async, [
                        writeFileR.bind(null, retinaImageName, results[1].image, 'binary'),
                        sendToPast.bind(null, retinaImageName, !isInitial)
                    ])
                ]),
